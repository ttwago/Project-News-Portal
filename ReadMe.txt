...
# создадим объекты "user_alex" и user_max связанные с пользователями "Alex" и 'Maxim' соответственно
...
# внесем посты в таблицу модели "Post" под созданными авторами:
...
# объекты модели "User" созданы выше п. 2 (user_alex, user_max)
